            ...
            <div className=" flex items-center justify-center">
              <div className="pr-2">
                ...
                <button
                  ...
                  className=" translate-y-1 text-black rounded-lg hover:text-blue-600 duration-500"
                >
                  <Search />
                </button>
              ...
              <div
                ...
                className="relative pr-2 inline-flex items-center space-x-2 cursor-pointer"
              >
                  ...
                  <SheetContent>
                    <SheetHeader>
                      <SheetTitle className=" flex items-center justify-center">
                        <img
                          src={logo}
                          className=" h-[50px] mx-[10px] rounded-full"
                        />
                        USV UK Limited
                      </SheetTitle>
                      <SheetDescription>
