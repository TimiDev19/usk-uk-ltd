...
const Landingpage = () => {
  ...
  return (
    <div className="pt-10">
      <div className=" h-[60vh] md:h-[70vh] lg:h-screen mb-6 home-bg flex items-center sm:justify-start justify-center text-center pxpx">
        <div className=" w-full sm:w-[40%] md:w-[60%] lg:w-[80%] sm:text-left mx2xl">
          <h1 className="uppercase text-4xl md:text-5xl lg:text-[72px] lg:leading-[1.2] font-bold text-white mb-6">
            we provide <span className=" text-blue-500">medical</span> products
      ...
      <div className=" exclusive-bg w-[100vw] py-20 pxpx mx2xl mb-20 flex items-center md:items-end justify-start">
        <div className=" md:w-[50%] mb-6 mx2xl">
          ...
          <p className=" font-thin text-white w-[65%] mb-4 md:text-xl">
            USV Exclusives. Elevate your skin with premium brands, where luxury
            meets comfort. Immerse yourself in a world of unparalleled elegance.
            Explore now!
          </p>
          <Link
            to={''}
